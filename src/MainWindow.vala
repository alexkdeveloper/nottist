...
private int mode;
        ...
        back_button_view_page = new Gtk.Button ();
            back_button_view_page.set_image (new Gtk.Image.from_icon_name ("go-previous", Gtk.IconSize.SMALL_TOOLBAR));
        ...
        back_button_name_page = new Gtk.Button();
            back_button_name_page.set_image (new Gtk.Image.from_icon_name ("go-previous", Gtk.IconSize.SMALL_TOOLBAR));
            back_button_name_page.vexpand = false;
        add_button = new Gtk.Button ();
            add_button.set_image (new Gtk.Image.from_icon_name ("document-new", Gtk.IconSize.SMALL_TOOLBAR));
            add_button.vexpand = false;
        view_button = new Gtk.Button ();
            view_button.set_image (new Gtk.Image.from_icon_name ("document-open", Gtk.IconSize.SMALL_TOOLBAR));
